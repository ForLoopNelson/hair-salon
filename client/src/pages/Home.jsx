    ...
    <div>
      ...
      <section id="services">
        ...
        <ul>
          ...
          <li>
            <strong>Coloring:</strong> Whether you want to enhance your natural
            color or try something bold and new, our color specialists are here
            to help.
          </li>
          <li>
            <strong>Treatments:</strong> Keep your hair healthy and strong with
            our deep conditioning and repair treatments.
          </li>
          <li>
